...
if(isset($_POST['update'])){
    ...
    $Dessert=$_POST["Dessert"];
        ...
        $query="UPDATE `dimanche` SET `entré` = '$entré', `platprincipal` = '$platprincipal', `Dessert` = '$Dessert'";
...
<h1>Update Your Information For Sunday</h1>
<div class="update_form">
    <form action="updatedimanche.php" method="POST" enctype="multipart/form-data">
